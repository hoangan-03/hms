...
const buttonVariants = cva(
    'inline-flex items-center justify-center gap-2 cursor-pointer whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none ',
    ...
    // focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]
    {
        variants: {
            variant: {
                ...
                cancel: 'bg-slate-300 text-slate-950 shadow-xs hover:bg-slate-300',

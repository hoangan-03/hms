...
const dropDatabase = async () => {
  ...
  try {
    ...
    await queryRunner.query("DROP TYPE IF EXISTS patients_gender_enum CASCADE");
    await queryRunner.query(
      "DROP TYPE IF EXISTS appointment_status_enum CASCADE"
    );
    await queryRunner.query(
      "DROP TYPE IF EXISTS appointments_timeslot_enum CASCADE"
    );
    await queryRunner.query("DROP TYPE IF EXISTS doctors_role_enum CASCADE");
    await queryRunner.query("DROP TYPE IF EXISTS patients_role_enum CASCADE");
